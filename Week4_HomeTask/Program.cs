...
namespace Test
{
    ...
    class Question
    {
        ...
        public void PrintAnswers()
        {
            ...
            {
                case 1:
                    Console.WriteLine("1. {0}		2. {1}		3. {2}		4. {3}",
                        correctAnswer, answerVariant1, answerVariant2, answerVariant3); correctAnswerNum = "1";
                    break;
                case 2:
                    Console.WriteLine("1. {0}		2. {1}		3. {2}		4. {3}",
                        answerVariant1, correctAnswer, answerVariant2, answerVariant3); correctAnswerNum = "2";
                    break;
                case 3:
                    Console.WriteLine("1. {0}		2. {1}		3. {2}		4. {3}",
                        answerVariant1, answerVariant2, correctAnswer, answerVariant3); correctAnswerNum = "3";
                    break;
                case 4:
                    Console.WriteLine("1. {0}		2. {1}		3. {2}		4. {3}",
                        answerVariant1, answerVariant2, answerVariant3, correctAnswer); correctAnswerNum = "4";
                    break;
            }
        }
